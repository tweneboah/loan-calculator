    ...
    <div className="App">
      ...
      <form className="form" onSubmit = {handleSubmit(onFormSubmit)}>
        <div className="form-group">
          <input type="text" placeholder="Amount" name = "amount" value = {formData.amount} onChange = {onChangeAmount}  ref = {register({required: true})} />
            <div className = 'text-danger'>{errors.amount && 'Amount  is required'}</div>
        </div>
      
        <div className="form-group">
          <input type="text" placeholder="Rate" name="rate" onChange = {onChnageRate} value = {formData.rate} />
